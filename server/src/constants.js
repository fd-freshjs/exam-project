module.exports = {
  ...
  SALT_ROUNDS: 5,
  SQUADHELP_BANK_NUMBER: process.env.SQUADHELP_BANK_NUMBER,
  SQUADHELP_BANK_NAME: process.env.SQUADHELP_BANK_NAME,
  SQUADHELP_BANK_CVC: process.env.SQUADHELP_BANK_CVC,
  SQUADHELP_BANK_EXPIRY: process.env.SQUADHELP_BANK_EXPIRY,
  CUSTOMER: 'customer',
  CREATOR: 'creator',
